...
public enum AuthErrorCode implements ErrorCode {
	...
	INVALID_ACCESS_TOKEN("AUTH-007", HttpStatus.UNAUTHORIZED, "INVALID_ACCESS_TOKEN"),
	EXPIRED_ACCESS_TOKEN("AUTH-008", HttpStatus.UNAUTHORIZED, "EXPIRED_ACCESS_TOKEN"),
	INVALID_REFRESH_TOKEN("AUTH-009", HttpStatus.UNAUTHORIZED, "INVALID_REFRESH_TOKEN"),
	;
